...
export const CartProvider = ({ children }) => {
    ...
    const fetchCart = useCallback(async (forceRefresh = false) => {
        ...
        try {
            ...
            response = await fetch(`https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/getCartProducts/${uid}`);
    ...
    const addToCart = async (product_id, product_type) => {
        ...
        try {
            const response = await fetch('https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/addToCart', {
                method: 'POST',
    ...
    const removeFromCart = async (cart_id) => {
        ...
        try {
            const response = await fetch(`https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/removeFromCart/${cart_id}`, { method: 'DELETE' });
            const data = await response.json();
