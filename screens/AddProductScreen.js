...
const AddProductScreen = ({ navigation }) => {
  ...
  const handleAddProduct = async () => {
    ...
    try {
      ...
      let endpoint = '';
      if (fileType === 'image') {
        endpoint = 'https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/uploadImageProduct';
      } else if (fileType === 'video') {
        endpoint = 'https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/uploadVideoProduct';
        productData.video_url = fileUrl;
        productData.thumbnail_url = thumbnailUrl;
      } else if (fileType === 'music') {
        endpoint = 'https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/uploadMusicProduct';
        productData.thumbnail_url = thumbnailUrl;
      }
