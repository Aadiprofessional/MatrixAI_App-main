    ...
    if (category === 'Images') {
      if (type === 'Best Deals') {
        const fetchBestDeals = async () => {
          try {
            const response = await fetch('https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/getBestDealsImageProducts');
        ...
        const fetchHighlight = async () => {
          try {
            const response = await fetch('https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/getHighlightsImageProducts');
            const data = await response.json();
            setHighlight(data);
          } catch (error) {
      ...
      if (type === 'Best Deals') {
        const fetchBestMusicDeals = async () => {
          try {
            const response = await fetch('https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/getBestDealsMusicProduct');
            const data = await response.json();
        ...
        const fetchHighlightMusic = async () => {
          try {
            const response = await fetch('https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/getHighlightsMusicProduct');
            const data = await response.json();
            setBestMusicDeals(data);
          } catch (error) {
