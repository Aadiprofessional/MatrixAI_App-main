...
import { REMOVE_BACKGROUND_UID } from '@env';
...
const RemoveBackground = () => {
  ...
  // Using environment variable instead of hardcoded UID
  const UID = REMOVE_BACKGROUND_UID || '595dfce5-0898-4364-9046-0aa850190321';
...
const fetchImages = async (UID) => {
    try {
      ...
      const response = await fetch(`https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/getRemoveBg?uid=595dfce5-0898-4364-9046-0aa850190321`);
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch('https://main-matrixai-server-lujmidrakh.cn-hangzhou.fcapp.run/uploadRemoveBg', {
        method: 'POST',
